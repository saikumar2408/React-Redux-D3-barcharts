...
return (
    ...
    <input className='InputElement' type='number' value={this.state.id} placeholder='enter your ID' onChange={(event) => this.setState({id: event.target.value})}/> 
        <input className='InputElement' type='text' value={this.state.name} placeholder='enter your name' onChange={(event) => this.setState({name: event.target.value})}/>
        ...
        <input className='InputElement' type='number' value={this.state.age} placeholder='enter your age' onChange={(event) => this.setState({age: event.target.value})}/>
        <input className='InputElement' type='number' value={this.state.experience} placeholder='enter your experience' onChange={(event) => this.setState({experience: event.target.value})}/>
